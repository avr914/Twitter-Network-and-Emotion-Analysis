...
class IntDeque(_object):
    ...
    def iterator(self):
        return _infomap.IntDeque_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _infomap.IntDeque___nonzero__(self)

    def __bool__(self):
        return _infomap.IntDeque___bool__(self)

    def __len__(self):
        return _infomap.IntDeque___len__(self)

    def pop(self):
        return _infomap.IntDeque_pop(self)

    def __getslice__(self, i, j):
        return _infomap.IntDeque___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _infomap.IntDeque___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _infomap.IntDeque___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _infomap.IntDeque___delitem__(self, *args)

    def __getitem__(self, *args):
        return _infomap.IntDeque___getitem__(self, *args)

    def __setitem__(self, *args):
        return _infomap.IntDeque___setitem__(self, *args)

    def append(self, x):
        return _infomap.IntDeque_append(self, x)

    def empty(self):
        return _infomap.IntDeque_empty(self)

    def size(self):
        return _infomap.IntDeque_size(self)

    def clear(self):
        return _infomap.IntDeque_clear(self)

    def swap(self, v):
        return _infomap.IntDeque_swap(self, v)

    def get_allocator(self):
        return _infomap.IntDeque_get_allocator(self)

    def begin(self):
        return _infomap.IntDeque_begin(self)

    def end(self):
        return _infomap.IntDeque_end(self)

    def rbegin(self):
        return _infomap.IntDeque_rbegin(self)

    def rend(self):
        return _infomap.IntDeque_rend(self)

    def pop_back(self):
        return _infomap.IntDeque_pop_back(self)

    def erase(self, *args):
        return _infomap.IntDeque_erase(self, *args)
    ...
    def push_back(self, x):
        return _infomap.IntDeque_push_back(self, x)

    def front(self):
        return _infomap.IntDeque_front(self)

    def back(self):
        return _infomap.IntDeque_back(self)

    def assign(self, n, x):
        return _infomap.IntDeque_assign(self, n, x)

    def resize(self, *args):
        return _infomap.IntDeque_resize(self, *args)

    def insert(self, *args):
        return _infomap.IntDeque_insert(self, *args)

    def pop_front(self):
        return _infomap.IntDeque_pop_front(self)

    def push_front(self, x):
        return _infomap.IntDeque_push_front(self, x)
...
class LeafIterator(_object):
    ...
    def clusterIndex(self):
        return _infomap.LeafIterator_clusterIndex(self)
...
class TreeIterator(_object):
    ...
    def clusterIndex(self):
        return _infomap.TreeIterator_clusterIndex(self)
...
class HierarchicalNetwork(_object):
    ...
    def leafIter(self, clusterIndexLevel=-1):
        return _infomap.HierarchicalNetwork_leafIter(self, clusterIndexLevel)

    def treeIter(self, clusterIndexLevel=-1):
        return _infomap.HierarchicalNetwork_treeIter(self, clusterIndexLevel)
    ...
    def writeClu(self, fileName, clusterIndexLevel=1):
        return _infomap.HierarchicalNetwork_writeClu(self, fileName, clusterIndexLevel)
