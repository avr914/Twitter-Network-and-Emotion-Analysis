...
with open('twitter-network_two_way.csv') as f_datin:
...
g = net.Graph(net.ego_graph(o, SEED, radius=6))
...
print labels
result = propagate_labels(core,labels)
print result
