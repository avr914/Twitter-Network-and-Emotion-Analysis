...
t = Twython(app_key='XRH8Wd2ZaDhAUmA5kEY5qGTrp',       #REPLACE 'APP_KEY' WITH YOUR APP KEY, ETC., IN THE NEXT 4 LINES
    app_secret='0rWg61r9DOMGFLXq5ebgLnDRC8xHqV1dgZYyaPVdwGO0sa6f4v',
    oauth_token='3154159514-wPdXqU9ayRiFEkzjfHVmFqVuDzQdK5SYJbsymH6',
    oauth_token_secret='KzRfzz9AHDkjB2r15dPsXcaqxzzkSGF5qDeTtnRveOEDn')

Base = declarative_base()

class TWEET(Base):
    __tablename__ = 'test_data' # This is table name, you can change to yours
...
class Scrape:
    def __init__(self):    
        engine = sqlalchemy.create_engine("sqlite:///twitter_data.sqlite", echo=True)  # enter your file path here.
